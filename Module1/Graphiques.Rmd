...
Ici, nous précisons dans l'argument geom_line que nous souhaitons que chaque courbe représente un arbre et nous spécifions que la couleur doit être en fonction de la valeur de la variable Tree.
...
```{r}
ggplot(subset(Orange, Tree==1), aes(x = age, y = circumference, colour = "RED")) + 
  geom_line()
```
